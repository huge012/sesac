# -*- coding: utf-8 -*-
"""01. 통계분석시각화 - matplotlib.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1W8vQ5hfv8H0xxUJI4EcR90ZgNhzxQGfb

### matplotlib 매뉴얼 사이트 : matplotlib.org
"""
...
# 마커 사용
plt.plot([1, 2, 3, 4, 5, 7],[1, 2, 9, 7, 12, 15], '_')  # 도면에 추가
plt.title("plt.plot[1, 4, 7, 9, 12, 15]")  # 제목 달기
plt.show()
...
# 마커+라인 사용 - 'o-r' 원+실선+색상
plt.plot([1, 2, 3, 4, 5, 7],[1, 2, 9, 7, 12, 15], 'o-.g')  # 도면에 추가
plt.title("plt.plot[1, 4, 7, 9, 12, 15], 'o:r")  # 제목 달기
plt.show()

#kwargs의 color
plt.plot([1, 2, 3, 4, 5, 7],[1, 2, 9, 7, 12, 15], 'o:', color='darkgray')  # 도면에 추가
plt.title("plt.plot[1, 4, 7, 9, 12, 15], 'o:', color='darkgreen'")  # 제목 달기
plt.show()
...
plt.plot('hour', 'distance', data=mdic)  # mdic 딕셔너리 데이터 사용, 키는 hour, distance
...
plt.title("예상 득표 수 - 에러값 표현하기, 캡 달기")
plt.show()

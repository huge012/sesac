# -*- coding: utf-8 -*-
"""01. 통계분석시각화 - Numpy 소개.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jOwDAlTO8febltFALOXBLKsZrcmH7osg
...
print("차원 : ", z_arr.ndim)
print("원소 형식 : ", z_arr.dtype) # 4 byte 실수 : float, 8 byte 실수 : double
...
print(a2[0][0]) # 인덱스 0인 원소 : 리스트[0, 1, 2, ... 19]의 인덱스 2인 원소

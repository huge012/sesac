...
Original file is located at
    https://colab.research.google.com/drive/1e3D4sGDwtlwsQJ2UbYg_Ak1lHYXaTha_
...
print(ls1) # ls1의 결과가 바뀐 것을 알 수 있음 (ls1에 ls2를 붙임)
print(ls2)
...
print(member_list)
name = input("지울 회원 : ")
member_list.remove(name) # 특정 요소 삭제
print(member_list)

member_list = ['홍길동', '강감찬', '을지문덕', '고길동', '김구','음냐뤼']

print(member_list)
member_list.clear() # 리스트를 전부 비움
print(member_list)
